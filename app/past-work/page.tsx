          ...
          >
            <Link href={`/past-work/${item.id}`}>
              <div className="group cursor-pointer">
                <div
                  className={`h-64 md:h-80 rounded-lg bg-gradient-to-br ${item.gradient} p-8 flex flex-col justify-end relative overflow-hidden transition-transform duration-300 group-hover:scale-[1.02]`}
                >
